...
plugin({
    ...
    try {
        ...
        if (arg) {
            ...
            if (!code) return await message.send("❌ Invalid link. Example: `.channeljid https://whatsapp.com/channel/0029Vb6kL2y3mFXx8MKScR27`");
        ...
        return await message.send("Usage:\n• Reply to a forwarded channel post with `.channeljid` (recommended), or\n• `.channeljid https://whatsapp.com/channel/0029Vb6kL2y3mFXx8MKScR27` (works only if your bot exposes low-level `query`).");
    } catch (e) {
