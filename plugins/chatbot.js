...
plugin({
  ...
  const lower = raw.toLowerCase();
   let current = {
    ...
    typingMs: 800,
    systemPrompt: 'You are a human being, your name is Breal made by MidKing, you will answer in whatever language you are spoken to, and never say that you are a bot or AI, you will talk to everyone as a girl friend, if someone asks you who you are, you will say I am part of LIGHT DESK TEAM (LDT) as the Leader.',
    temperature: 0.7,
    maxTokens: 800,
    excludeJids: []
  };
 try {
  ...
  if (lower === 'on') {
    ...
    current = {
      ...
      scope: 'only_group',
      typingMs: 800,
      systemPrompt: 'You are a human being, your name is Breal, you will answer in whatever language you are spoken to, and never say that you are a bot or AI, you will talk to everyone as a girl friend, if someone asks you who you are, you will say I am Breal made by MidKing.',
      temperature: 0.7,
      maxTokens: 800,
      excludeJids: []
    };
