...
async function downloadSessionFromMega(file_path) {
  ...
  try {
    const sessPart = config.SESSION_ID.replace('BREAL-MD:~', '');
...
//=================================================================================
    ...
    function externalPreview(profileImage, options = {}) {
      return {
          ...
          thumbnailUrl: profileImage || 'https://files.catbox.moe/4qwyn2.jpeg',
          sourceUrl: options.sourceUrl || 'https://whatsapp.com/channel/0029VaraMtfFcowAKRdDdp1T',
          mediaType: 1,
      ...
      for (const user of participants) {
        ...
        try {
          ...
          profileImage = 'https://files.catbox.moe/2x5uj5.jpeg';
        }
...
//=================================================================================
     ...
     function externalGoodbyePreview(profileImage, options = {}) {
        return {
            ...
            body: options.body || name,
            thumbnailUrl: profileImage || 'https://files.catbox.moe/2x5uj5.jpeg',
            sourceUrl: options.sourceUrl || 'https://whatsapp.com/channel/0029Vb6kL2y3mFXx8MKScR27',
            mediaType: 1,
            renderLargerThumbnail: true
        };
     }
...
app.listen(config.PORT, () => console.log(`🎈 BREAL Server listening on port http://localhost:${config.PORT}`));
}
